CREATE TABLE raw_ddl.kaggle_tabular_2208_test (
     id int
...
alter table raw_ddl.kaggle_tabular_2208_test owner to rw_role;
grant select on raw_ddl.kaggle_tabular_2208_test to duckienukeem;

copy raw_ddl.kaggle_tabular_2208_test (
     id
    ,product_code
    ,loading
    ,attribute_0
...
FROM '/mountpoint/Kaggle/tabular/test.csv'
DELIMITER ','
csv HEADER;
